...
<title>Register — Mandi Prime</title>
...
<div class="auth-shell">
  ...
  <div class="auth-form">
    <div class="auth-card">
      ...
      <div class="sub">Register to start buying from Mandi Prime.</div>
      ...
      <form method="POST" action="{{ route('register') }}">
        ...
        <button type="submit" class="btn-primary btn-block" style="margin-top:10px;">Register</button>
      </form>
    </div>
  </div>
</div>
